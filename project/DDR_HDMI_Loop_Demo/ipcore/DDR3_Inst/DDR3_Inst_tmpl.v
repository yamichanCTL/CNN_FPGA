...
DDR3_Inst the_instance_name (
  ...
  .debug_data(debug_data),                              // output [67:0]
  .debug_slice_state(debug_slice_state),                // output [25:0]
  ...
  .update_com_val_err_flag(update_com_val_err_flag),    // output [1:0]
