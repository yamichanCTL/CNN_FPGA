...
net.conv_123.weight.data= torch.from_numpy(np.load(
    r'../parameters/model.13.m.0.cv1.conv.weight.npy').astype(np.float32))
net.conv_126.weight.data= torch.from_numpy(np.load(
    r'../parameters/model.13.m.0.cv2.conv.weight.npy').astype(np.float32))
...
net.conv_145.weight.data= torch.from_numpy(np.load(
    r'../parameters/model.17.m.0.cv1.conv.weight.npy').astype(np.float32))
net.conv_148.weight.data= torch.from_numpy(np.load(
    r'../parameters/model.17.m.0.cv2.conv.weight.npy').astype(np.float32))
...
net.conv_165.weight.data= torch.from_numpy(np.load(
    r'../parameters/model.20.m.0.cv1.conv.weight.npy').astype(np.float32))
net.conv_168.weight.data= torch.from_numpy(np.load(
    r'../parameters/model.20.m.0.cv2.conv.weight.npy').astype(np.float32))
...
net.conv_185.weight.data= torch.from_numpy(np.load(
    r'../parameters/model.23.m.0.cv1.conv.weight.npy').astype(np.float32))
net.conv_188.weight.data= torch.from_numpy(np.load(
    r'../parameters/model.23.m.0.cv2.conv.weight.npy').astype(np.float32))
